...
nnoremap L <Cmd>call <SID>gotoEditor(v:count, 'next')<CR>
xnoremap L <Cmd>call <SID>gotoEditor(v:count, 'next')<CR>
nnoremap H <Cmd>call <SID>switchEditor(v:count, 'prev')<CR>
xnoremap H <Cmd>call <SID>switchEditor(v:count, 'prev')<CR>
