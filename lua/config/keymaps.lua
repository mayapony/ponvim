...
-- Don't yank on some operation
local dontYankOper = { "x", "X", "d", "c" }
for _, oper in ipairs(dontYankOper) do
	map("n", oper, string.format([["_%s]], oper))
	map("v", oper, string.format([["_%s]], oper))
end
